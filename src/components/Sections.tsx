    ...
    <section id="story" className="py-24 px-6 bg-cream flex justify-center">
      <div className="max-w-[820px] w-full">
        <motion.span
          ...
          viewport={{ once: true }}
          className="eyebrow text-brown block mb-8"
        >
          {t.why.eyebrow}
        </motion.span>
        <motion.h3
  ...
  return (
    <section className="py-24 px-6 bg-dark text-cream flex justify-center overflow-hidden relative">
      <div className="max-w-[820px] w-full relative z-10">
        ...
        <div className="mb-12">
          <span className="font-display text-[0.6rem] tracking-[0.2em] text-muted block mb-2">{t.origin.date}</span>
          <motion.h3
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
    ...
    <section id="symbols" className="py-24 px-6 bg-cream-dark flex justify-center">
      <div className="max-w-[820px] w-full">
        <motion.h3
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          className="text-sm font-display tracking-[0.4em] uppercase text-brown mb-16 text-center"
        >
          {t.symbols.title}
        </motion.h3>
      ...
      <div className="max-w-3xl mx-auto space-y-16">
        ...
        >
          <motion.h2
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-serif italic mb-12 block text-brown"
          >
            "{t.payoff}"
          </motion.h2>
          <span className="eyebrow text-brown/60 mb-4 block">
            {t.philosophy.title}
          </span>
        </motion.div>
