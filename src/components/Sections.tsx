    ...
    <section id="story" className="py-24 px-6 bg-cream flex justify-center">
      <div className="max-w-[820px] w-full">
        <motion.span
          ...
          viewport={{ once: true }}
          /* Change: Standardized eyebrow with text-base and tracking */
        ...
        <motion.h3
          ...
          viewport={{ once: true }}
          /* Change: text-3xl md:text-5xl -> text-4xl md:text-6xl */
    ...
    <section className="py-24 px-6 bg-dark text-cream flex justify-center overflow-hidden relative">
      <div className="max-w-[820px] w-full relative z-10">
        <motion.span
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          /* Change: Added text-base */
          className="eyebrow text-base text-warm block mb-8"
        >
          {t.origin.eyebrow}
        </motion.span>
        <div className="mb-12">
          {/* Change: Date check text-[0.6rem] -> text-[0.8rem] */}
  ...
  return (
    <section id="waitlist" className="py-24 px-6 bg-dark text-cream flex justify-center">
      <div className="max-w-md w-full text-center">
        ...
        {/* Change: Updated to 4xl to match section scale */}
